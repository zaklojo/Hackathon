Public Class clsAntecedentsMedicaments
    ...
    Public Overloads Sub mapping(ByVal dataAccess As dataAccessObjet, ligne As Integer)
        With dataAccess.ds
            id_medicament = verifierColonneDataSet(.Tables(0), ligne, constantes_antecedents_medicaments.STR_ID_ANTECEDENTS_MEDICAMENTS)
            assurance_maladie = verifierColonneDataSet(.Tables(0), ligne, constantes_antecedents_medicaments.STR_ASSURANCE_MALADIE)
        End With
    End Sub
