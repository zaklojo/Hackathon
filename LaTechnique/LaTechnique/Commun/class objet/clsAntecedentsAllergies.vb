Public Class clsAntecedentsAllergies
    ...
    Public Overloads Sub mapping(ByVal dataAccess As dataAccessObjet, ligne As Integer)
        With dataAccess.ds
            id_allergie = verifierColonneDataSet(.Tables(0), ligne, constantes_antecedents_allergies.STR_ID_ANTECEDENTS_ALLERGIES)
            assurance_maladie = verifierColonneDataSet(.Tables(0), ligne, constantes_antecedents_allergies.STR_ASSURANCE_MALADIE)
        End With
    End Sub
